...
describe('Should test at a functional level', () => {
    after(() => {
        ...
        cy.get(loc.CLOSE_MESSAGE).click( {multiple: true})
    })
    ...
    it('Should create a transaction', () => {
        ...
        cy.get(loc.TELA_MOVIMENTACAO.DESCRICAO).type('Desc')
        cy.get(loc.TELA_MOVIMENTACAO.VALOR).type('123')
        cy.get(loc.TELA_MOVIMENTACAO.INTERESSADO).type('Inter')
        cy.get(loc.TELA_MOVIMENTACAO.CONTA).select('Banco')
